...
<body>
<div class="charges">
 <fieldset ><legend><button  style="background-color: brown"><a href="home.php" style="text-decoration:none;"><b>HOME</b></a></button></legend> 
 <table border="0"> 
<form id="frm" method="post" action="charges_rct.php">
  ...
  <tr>
    ...
    <td><b>Type</b></td><td>
    <select id="ptype" name="ptype" style="width:180px" ><option>Select Payment Type</option>
    <?php ptype(); ?>
    </select></td></tr><tr>
    <td><b>Amount</b></td><td>
   ...
   <input type="hidden" name="rctno" value="autoref()" id="rctno"></td>
     </tr>
